...
(10, 'Anna', 'Smith', 'Australian', 1940, 2000);
...
INSERT INTO `book` (`BookID`, `BookTitle`, `OriginalTitle`, `YearofPublication`, `Genre`, `MillionsSold`, `LanguageWritten`, `imageURL`, `AuthorID`, `DateCreated`) VALUES
(1, 'Don Quixote', 'El Ingenioso Hidalgo Don Quixote de la Mancha', 1605, 'Novel', 500, 'Spanish', '../images/DonQuixote.jpg', 1, '2018-04-02 09:00:00'),
(2, 'A Tale of Two Cities', 'A Tale of Two Cities', 1859, 'Historical Fiction', 200, 'English', '../images/aTaleofTwoCities.jpg', 2, '2018-04-09 08:00:00'),
(3, 'The Lord of the Rings', 'The Lord of the Rings', 1954, 'Fantasy/Adventure', 150, 'English', '../images/default.png', 3, '2018-04-11 11:00:00'),
(4, 'The Litle Prince', 'Le Petit Prince', 1943, 'Fable', 142, 'French', '../images/theLittlePrince.jpg', 4, '2018-04-14 19:00:00'),
(5, 'Harry Potter and the Sorcerer\'s Stone', 'Harry Potter and the Sorcerer\'s Stone', 1997, 'Fantasy Fiction', 107, 'English', '../images/default.png', 5, '2018-04-10 11:00:00'),
(6, 'And Then There Were None', 'Ten Little Niggers', 1939, 'Mystery', 100, 'English', '../images/andThenThereWereNone.jpg', 6, '2018-04-05 14:00:00'),
(7, 'The Dream of the Red Chamber', 'The Story of the Stone', 1792, 'Novel', 100, 'Chinese', '../images/redChamber.jpg', 7, '2018-03-04 07:00:00'),
(8, 'The Hobbit ', 'There and Back Again', 1937, 'High Fantasy', 100, 'English', '../images/theHobbit.jpg', 3, '2018-04-20 08:00:00'),
(9, 'She: A History of Adventure', 'She', 1886, 'FIction', 100, 'English', '../images/She.jpg', 8, '2018-04-26 11:00:00'),
(10, 'The Lion, the Witch and the Wardrobe', 'The Lion, the Witch and the Wardrobe', 1950, 'Fantasy', 85, 'English ', '../images/default.png', 9, '2018-04-23 19:00:00'),
(11, 'The Test Book', 'test', 1960, 'Novel', 2, 'English', '../images/test_bookcover.jpg', 10, '2018-04-23 22:26:25');
...
CREATE TABLE `book_update` (
  `book_updateID` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `book_update` (`book_updateID`, `dateUpdated`, `usersID`, `BookID`) VALUES
(1, '2018-04-29 21:52:09', 1, 11);
...
(1, 'jess_yeoh', '$2y$10$Ft/1JzZdHbpk4iNoQAtj9.CkCmo/TtAeit0PlzapHuL0MfiAhsQkm'),
(2, 'test_employee', '$2y$10$IXMVFLd7pvHe3dEUxBsnlOKq9hL/rmTlfLFZYKwgDZCZbKGSdv7he'),
(3, 'test6', '$2y$10$vBqtzq9T7HAcNDicrIAop.RgZ8Wi.n6zoc67fZxkmFFMZshVpizCO');
...
INSERT INTO `users` (`usersID`, `firstName`, `surname`, `userRole`, `LogInID`) VALUES
(1, 'Jessica', 'Yeoh', 'Administrator', 1),
(2, 'John', 'Smith', 'Employee', 2),
(3, 'Test', 'Test', 'Employee', 3);
...
--
-- Indexes for table `book_update`
--
ALTER TABLE `book_update`
  ADD PRIMARY KEY (`book_updateID`),
...
--
ALTER TABLE `bookplot`
  MODIFY `BookPlotID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `bookranking`
--
ALTER TABLE `bookranking`
  MODIFY `RankingID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `book_update`
--
ALTER TABLE `book_update`
  MODIFY `book_updateID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `users`
  MODIFY `usersID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `book_update`
--
ALTER TABLE `book_update`
  ADD CONSTRAINT `BookID` FOREIGN KEY (`BookID`) REFERENCES `book` (`BookID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usersID` FOREIGN KEY (`usersID`) REFERENCES `users` (`usersID`) ON DELETE CASCADE ON UPDATE CASCADE;
